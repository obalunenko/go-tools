...
|--------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [buf](https://github.com/bufbuild/buf)                       | v1.71.0 | The buf CLI is the best tool for working with Protocol Buffers                                                                                                                    |
...
| [mockery](https://github.com/vektra/mockery)                 | v3.7.1 | A mock code autogenerator for Go                                                                                                                                                  |
| [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) | v2.7.1 | Generate Go client and server boilerplate from OpenAPI 3 specifications                                                                                                           |
