...
The base image is built on top of the official image [golang:1.25.5-alpine3.22](https://hub.docker.com/_/golang) and includes the following tools:
...
| [golangci-lint](https://github.com/golangci/golangci-lint)   | v2.7.1 | Fast linters Runner for Go                                                                                                                                                        |
