...
|--------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [buf](https://github.com/bufbuild/buf)                       | v1.60.0 | The buf CLI is the best tool for working with Protocol Buffers                                                                                                                    |
...
| [golangci-lint](https://github.com/golangci/golangci-lint)   | v2.6.2 | Fast linters Runner for Go                                                                                                                                                        |
...
| [mockery](https://github.com/vektra/mockery)                 | v3.6.0 | A mock code autogenerator for Go                                                                                                                                                  |
