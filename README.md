...
The base image is built on top of the official image [golang:1.26.4-alpine3.23](https://hub.docker.com/_/golang) and includes the following tools:

#### Below is a full manifest of the tools available

| Tool                                                         | Version                            | Description                                                                                                                                                                       |
|--------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [buf](https://github.com/bufbuild/buf)                       | v1.72.0 | The buf CLI is the best tool for working with Protocol Buffers                                                                                                                    |
...
| [golangci-lint](https://github.com/golangci/golangci-lint)   | v2.12.2 | Fast linters Runner for Go                                                                                                                                                        |
...
| [goreleaser](https://github.com/goreleaser/goreleaser)       | v2.17.1 | Deliver Go binaries as fast and easily as possible                                                                                                                                |
...
| [mockery](https://github.com/vektra/mockery)                 | v3.7.2 | A mock code autogenerator for Go                                                                                                                                                  |
| [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) | v2.8.0 | Generate Go client and server boilerplate from OpenAPI 3 specifications                                                                                                           |
...
| [sqlc](https://github.com/sqlc-dev/sqlc)                     | v1.31.1 | Generate type-safe code from SQL                                                                                                                                                  |
...
| [swagger](https://github.com/go-swagger/go-swagger)          | v0.36.1 | Client/Server from OpenAPI docs generation tool                                                                                                                                   |
