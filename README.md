...
The base image is built on top of the official image [golang:1.26.3-alpine3.22](https://hub.docker.com/_/golang) and includes the following tools:
...
| [goreleaser](https://github.com/goreleaser/goreleaser)       | v2.15.4 | Deliver Go binaries as fast and easily as possible                                                                                                                                |
