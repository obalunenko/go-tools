...
The base image is built on top of the official image [golang:1.26.3-alpine3.23](https://hub.docker.com/_/golang) and includes the following tools:

#### Below is a full manifest of the tools available

| Tool                                                         | Version                            | Description                                                                                                                                                                       |
|--------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [buf](https://github.com/bufbuild/buf)                       | v1.70.0 | The buf CLI is the best tool for working with Protocol Buffers                                                                                                                    |
...
| [goreleaser](https://github.com/goreleaser/goreleaser)       | v2.16.0 | Deliver Go binaries as fast and easily as possible                                                                                                                                |
...
| [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) | v2.7.0 | Generate Go client and server boilerplate from OpenAPI 3 specifications                                                                                                           |
...
| [swagger](https://github.com/go-swagger/go-swagger)          | v0.34.0 | Client/Server from OpenAPI docs generation tool                                                                                                                                   |
