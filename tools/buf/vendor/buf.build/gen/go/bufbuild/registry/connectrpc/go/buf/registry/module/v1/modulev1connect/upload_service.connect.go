...
// Upload calls buf.registry.module.v1.UploadService.Upload.
...
func (UnimplementedUploadServiceHandler) Upload(context.Context, *connect.Request[v1.UploadRequest]) (*connect.Response[v1.UploadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.module.v1.UploadService.Upload is not implemented"))
}
