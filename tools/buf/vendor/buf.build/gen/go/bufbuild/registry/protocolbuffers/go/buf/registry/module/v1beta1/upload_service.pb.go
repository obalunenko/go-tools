...
func (*UploadRequest) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1beta1_upload_service_proto_rawDescGZIP(), []int{0}
}
...
func (*UploadResponse) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1beta1_upload_service_proto_rawDescGZIP(), []int{1}
}
...
func (*UploadRequest_DepRef) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1beta1_upload_service_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*UploadRequest_Content) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1beta1_upload_service_proto_rawDescGZIP(), []int{0, 1}
}
...
var (
	file_buf_registry_module_v1beta1_upload_service_proto_rawDescOnce sync.Once
	file_buf_registry_module_v1beta1_upload_service_proto_rawDescData = file_buf_registry_module_v1beta1_upload_service_proto_rawDesc
)

func file_buf_registry_module_v1beta1_upload_service_proto_rawDescGZIP() []byte {
	file_buf_registry_module_v1beta1_upload_service_proto_rawDescOnce.Do(func() {
		file_buf_registry_module_v1beta1_upload_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_module_v1beta1_upload_service_proto_rawDescData)
	})
	return file_buf_registry_module_v1beta1_upload_service_proto_rawDescData
}
