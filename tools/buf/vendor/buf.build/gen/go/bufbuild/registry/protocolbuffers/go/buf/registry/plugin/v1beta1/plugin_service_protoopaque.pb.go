...
const file_buf_registry_plugin_v1beta1_plugin_service_proto_rawDesc = "" +
	...
	"\aplugins\x18\x01 \x03(\v2#.buf.registry.plugin.v1beta1.PluginB\b\xbaH\x05\x92\x01\x02\b\x01R\aplugins\"\x9d\x04\n" +
	"\x14UpdatePluginsRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.plugin.v1beta1.UpdatePluginsRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xa6\x03\n" +
	"\x05Value\x12M\n" +
	"\n" +
	"plugin_ref\x18\x01 \x01(\v2&.buf.registry.plugin.v1beta1.PluginRefB\x06\xbaH\x03\xc8\x01\x01R\tpluginRef\x12_\n" +
	"\n" +
	"visibility\x18\x02 \x01(\x0e2-.buf.registry.plugin.v1beta1.PluginVisibilityB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x00R\n" +
	"visibility\x88\x01\x01\x12P\n" +
	"\x05state\x18\x03 \x01(\x0e2(.buf.registry.plugin.v1beta1.PluginStateB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x01R\x05state\x88\x01\x01\x12/\n" +
