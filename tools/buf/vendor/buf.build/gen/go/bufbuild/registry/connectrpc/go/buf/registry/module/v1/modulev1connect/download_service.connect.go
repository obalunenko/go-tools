...
var (
	downloadServiceServiceDescriptor        = v1.File_buf_registry_module_v1_download_service_proto.Services().ByName("DownloadService")
...
// Download calls buf.registry.module.v1.DownloadService.Download.
func (c *downloadServiceClient) Download(ctx context.Context, req *connect.Request[v1.DownloadRequest]) (*connect.Response[v1.DownloadResponse], error) {
...
func NewDownloadServiceHandler(svc DownloadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.module.v1.DownloadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDownloadServiceHandler) Download(context.Context, *connect.Request[v1.DownloadRequest]) (*connect.Response[v1.DownloadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.module.v1.DownloadService.Download is not implemented"))
}
