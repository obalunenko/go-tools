...
type PolicyConfig struct {
	...
	xxx_hidden_Lint     *PolicyConfig_LintConfig           `protobuf:"bytes,1,opt,name=lint,proto3"`
	xxx_hidden_Breaking *PolicyConfig_BreakingConfig       `protobuf:"bytes,2,opt,name=breaking,proto3"`
	xxx_hidden_Plugins  *[]*PolicyConfig_CheckPluginConfig `protobuf:"bytes,3,rep,name=plugins,proto3"`
...
func (x *PolicyConfig) HasBreaking() bool {
	...
	return x.xxx_hidden_Breaking != nil
}

func (x *PolicyConfig) ClearLint() {
	x.xxx_hidden_Lint = nil
}

func (x *PolicyConfig) ClearBreaking() {
	x.xxx_hidden_Breaking = nil
}
...
type PolicyConfig_LintConfig struct {
	state                                           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Use                                  []string               `protobuf:"bytes,1,rep,name=use,proto3"`
	xxx_hidden_Except                               []string               `protobuf:"bytes,2,rep,name=except,proto3"`
	xxx_hidden_EnumZeroValueSuffix                  string                 `protobuf:"bytes,3,opt,name=enum_zero_value_suffix,json=enumZeroValueSuffix,proto3"`
	xxx_hidden_RpcAllowSameRequestResponse          bool                   `protobuf:"varint,4,opt,name=rpc_allow_same_request_response,json=rpcAllowSameRequestResponse,proto3"`
	xxx_hidden_RpcAllowGoogleProtobufEmptyRequests  bool                   `protobuf:"varint,5,opt,name=rpc_allow_google_protobuf_empty_requests,json=rpcAllowGoogleProtobufEmptyRequests,proto3"`
	xxx_hidden_RpcAllowGoogleProtobufEmptyResponses bool                   `protobuf:"varint,6,opt,name=rpc_allow_google_protobuf_empty_responses,json=rpcAllowGoogleProtobufEmptyResponses,proto3"`
	xxx_hidden_ServiceSuffix                        string                 `protobuf:"bytes,7,opt,name=service_suffix,json=serviceSuffix,proto3"`
	xxx_hidden_DisableBuiltin                       bool                   `protobuf:"varint,8,opt,name=disable_builtin,json=disableBuiltin,proto3"`
	unknownFields                                   protoimpl.UnknownFields
	sizeCache                                       protoimpl.SizeCache
}
...
func (x *PolicyConfig_LintConfig) GetDisableBuiltin() bool {
	if x != nil {
		return x.xxx_hidden_DisableBuiltin
	}
	return false
}
...
func (b0 PolicyConfig_LintConfig_builder) Build() *PolicyConfig_LintConfig {
	...
	x.xxx_hidden_DisableBuiltin = b.DisableBuiltin
	return m0
}
...
type PolicyConfig_BreakingConfig struct {
	...
	xxx_hidden_Use                    []string               `protobuf:"bytes,1,rep,name=use,proto3"`
	xxx_hidden_Except                 []string               `protobuf:"bytes,2,rep,name=except,proto3"`
	xxx_hidden_IgnoreUnstablePackages bool                   `protobuf:"varint,3,opt,name=ignore_unstable_packages,json=ignoreUnstablePackages,proto3"`
	xxx_hidden_DisableBuiltin         bool                   `protobuf:"varint,4,opt,name=disable_builtin,json=disableBuiltin,proto3"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
type PolicyConfig_CheckPluginConfig struct {
	state              protoimpl.MessageState               `protogen:"opaque.v1"`
	xxx_hidden_Name    *PolicyConfig_CheckPluginConfig_Name `protobuf:"bytes,1,opt,name=name,proto3"`
	xxx_hidden_Options *[]*v1.Option                        `protobuf:"bytes,3,rep,name=options,proto3"`
	xxx_hidden_Args    []string                             `protobuf:"bytes,4,rep,name=args,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
