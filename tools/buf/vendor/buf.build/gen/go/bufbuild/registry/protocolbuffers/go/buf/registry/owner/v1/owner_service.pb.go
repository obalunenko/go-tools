...
func (*GetOwnersRequest) Descriptor() ([]byte, []int) {
	return file_buf_registry_owner_v1_owner_service_proto_rawDescGZIP(), []int{0}
}
...
func (*GetOwnersResponse) Descriptor() ([]byte, []int) {
	return file_buf_registry_owner_v1_owner_service_proto_rawDescGZIP(), []int{1}
}
...
var file_buf_registry_owner_v1_owner_service_proto_rawDesc = []byte{
...
var (
	file_buf_registry_owner_v1_owner_service_proto_rawDescOnce sync.Once
	file_buf_registry_owner_v1_owner_service_proto_rawDescData = file_buf_registry_owner_v1_owner_service_proto_rawDesc
)

func file_buf_registry_owner_v1_owner_service_proto_rawDescGZIP() []byte {
	file_buf_registry_owner_v1_owner_service_proto_rawDescOnce.Do(func() {
		file_buf_registry_owner_v1_owner_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_owner_v1_owner_service_proto_rawDescData)
	})
	return file_buf_registry_owner_v1_owner_service_proto_rawDescData
}
...
func file_buf_registry_owner_v1_owner_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_buf_registry_owner_v1_owner_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_buf_registry_owner_v1_owner_service_proto_rawDesc = nil
