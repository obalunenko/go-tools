...
// NewGraphServiceClient constructs a client for the buf.registry.module.v1beta1.GraphService
...
func NewGraphServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GraphServiceClient {
	...
	graphServiceMethods := v1beta1.File_buf_registry_module_v1beta1_graph_service_proto.Services().ByName("GraphService").Methods()
...
// GetGraph calls buf.registry.module.v1beta1.GraphService.GetGraph.
func (c *graphServiceClient) GetGraph(ctx context.Context, req *connect.Request[v1beta1.GetGraphRequest]) (*connect.Response[v1beta1.GetGraphResponse], error) {
...
func NewGraphServiceHandler(svc GraphServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.module.v1beta1.GraphService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGraphServiceHandler) GetGraph(context.Context, *connect.Request[v1beta1.GetGraphRequest]) (*connect.Response[v1beta1.GetGraphResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.module.v1beta1.GraphService.GetGraph is not implemented"))
}
