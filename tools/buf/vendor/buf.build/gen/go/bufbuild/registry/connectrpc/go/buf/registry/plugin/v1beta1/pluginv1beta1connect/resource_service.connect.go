...
// NewResourceServiceClient constructs a client for the buf.registry.plugin.v1beta1.ResourceService
...
// GetResources calls buf.registry.plugin.v1beta1.ResourceService.GetResources.
...
// ResourceServiceHandler is an implementation of the buf.registry.plugin.v1beta1.ResourceService
// service.
...
func NewResourceServiceHandler(svc ResourceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.plugin.v1beta1.ResourceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResourceServiceHandler) GetResources(context.Context, *connect.Request[v1beta1.GetResourcesRequest]) (*connect.Response[v1beta1.GetResourcesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.ResourceService.GetResources is not implemented"))
}
