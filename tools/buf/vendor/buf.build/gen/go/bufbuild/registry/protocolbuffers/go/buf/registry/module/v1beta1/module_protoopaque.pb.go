...
type Module struct {
	...
	xxx_hidden_Visibility       ModuleVisibility       `protobuf:"varint,6,opt,name=visibility,proto3,enum=buf.registry.module.v1beta1.ModuleVisibility"`
	xxx_hidden_State            ModuleState            `protobuf:"varint,7,opt,name=state,proto3,enum=buf.registry.module.v1beta1.ModuleState"`
	...
	xxx_hidden_DefaultLabelName string                 `protobuf:"bytes,10,opt,name=default_label_name,json=defaultLabelName,proto3"`
...
type ModuleRef struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Value isModuleRef_Value      `protobuf_oneof:"value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ModuleRef) GetId() string {
	if x != nil {
		if x, ok := x.xxx_hidden_Value.(*moduleRef_Id); ok {
			return x.Id
		}
	}
	return ""
...
func (x *ModuleRef) GetName() *ModuleRef_Name {
	if x != nil {
		if x, ok := x.xxx_hidden_Value.(*moduleRef_Name_); ok {
			return x.Name
		}
	}
	return nil
...
func (x *ModuleRef) SetId(v string) {
	x.xxx_hidden_Value = &moduleRef_Id{v}
}
...
func (x *ModuleRef) SetName(v *ModuleRef_Name) {
	...
	x.xxx_hidden_Value = &moduleRef_Name_{v}
}
...
func (x *ModuleRef) HasId() bool {
	...
	_, ok := x.xxx_hidden_Value.(*moduleRef_Id)
	return ok
}
...
func (x *ModuleRef) HasName() bool {
	...
	_, ok := x.xxx_hidden_Value.(*moduleRef_Name_)
	return ok
}
...
func (x *ModuleRef) ClearId() {
	if _, ok := x.xxx_hidden_Value.(*moduleRef_Id); ok {
		x.xxx_hidden_Value = nil
	}
}

func (x *ModuleRef) ClearName() {
	if _, ok := x.xxx_hidden_Value.(*moduleRef_Name_); ok {
		x.xxx_hidden_Value = nil
	}
}
...
func (b0 ModuleRef_builder) Build() *ModuleRef {
	...
	_, _ = b, x
	if b.Id != nil {
		x.xxx_hidden_Value = &moduleRef_Id{*b.Id}
	}
	if b.Name != nil {
		x.xxx_hidden_Value = &moduleRef_Name_{b.Name}
	}
	return m0
}
...
const file_buf_registry_module_v1beta1_module_proto_rawDesc = "" +
	"\n" +
	"(buf/registry/module/v1beta1/module.proto\x12\x1bbuf.registry.module.v1beta1\x1a3buf/registry/priv/extension/v1beta1/extension.proto\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb0\x04\n" +
	"\x06Module\x12\x1b\n" +
	...
	"\n" +
	"visibility\x18\x06 \x01(\x0e2-.buf.registry.module.v1beta1.ModuleVisibilityB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\n" +
	"visibility\x12K\n" +
	"\x05state\x18\a \x01(\x0e2(.buf.registry.module.v1beta1.ModuleStateB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x05state\x12*\n" +
	...
	" \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\x18\xfa\x01R\x10defaultLabelName:\x06\xea\xc5+\x02\x10\x01\"\xcf\x01\n" +
	"\tModuleRef\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x88\x02\x01H\x00R\x02id\x12A\n" +
	"\x04name\x18\x02 \x01(\v2+.buf.registry.module.v1beta1.ModuleRef.NameH\x00R\x04name\x1aK\n" +
	"\x04Name\x12 \n" +
	...
	"\x17MODULE_STATE_DEPRECATED\x10\x02BaZ_buf.build/gen/go/bufbuild/registry/protocolbuffers/go/buf/registry/module/v1beta1;modulev1beta1b\x06proto3"
