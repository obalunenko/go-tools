...
const (
	...
	// RPC.
	CommitServiceGetCommitsProcedure = "/buf.registry.plugin.v1beta1.CommitService/GetCommits"
	// CommitServiceListCommitsProcedure is the fully-qualified name of the CommitService's ListCommits
	// RPC.
	CommitServiceListCommitsProcedure = "/buf.registry.plugin.v1beta1.CommitService/ListCommits"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	commitServiceServiceDescriptor           = v1beta1.File_buf_registry_plugin_v1beta1_commit_service_proto.Services().ByName("CommitService")
...
// NewCommitServiceClient constructs a client for the buf.registry.plugin.v1beta1.CommitService
...
// GetCommits calls buf.registry.plugin.v1beta1.CommitService.GetCommits.
...
// ListCommits calls buf.registry.plugin.v1beta1.CommitService.ListCommits.
...
// CommitServiceHandler is an implementation of the buf.registry.plugin.v1beta1.CommitService
// service.
...
func NewCommitServiceHandler(svc CommitServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.plugin.v1beta1.CommitService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCommitServiceHandler) GetCommits(context.Context, *connect.Request[v1beta1.GetCommitsRequest]) (*connect.Response[v1beta1.GetCommitsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.CommitService.GetCommits is not implemented"))
}
...
func (UnimplementedCommitServiceHandler) ListCommits(context.Context, *connect.Request[v1beta1.ListCommitsRequest]) (*connect.Response[v1beta1.ListCommitsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.CommitService.ListCommits is not implemented"))
}
