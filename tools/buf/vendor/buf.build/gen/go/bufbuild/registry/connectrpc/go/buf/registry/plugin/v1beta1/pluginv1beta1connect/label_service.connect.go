...
var (
	labelServiceServiceDescriptor                    = v1beta1.File_buf_registry_plugin_v1beta1_label_service_proto.Services().ByName("LabelService")
...
// GetLabels calls buf.registry.plugin.v1beta1.LabelService.GetLabels.
...
// ListLabels calls buf.registry.plugin.v1beta1.LabelService.ListLabels.
...
// ListLabelHistory calls buf.registry.plugin.v1beta1.LabelService.ListLabelHistory.
...
// CreateOrUpdateLabels calls buf.registry.plugin.v1beta1.LabelService.CreateOrUpdateLabels.
...
// ArchiveLabels calls buf.registry.plugin.v1beta1.LabelService.ArchiveLabels.
...
// UnarchiveLabels calls buf.registry.plugin.v1beta1.LabelService.UnarchiveLabels.
...
func NewLabelServiceHandler(svc LabelServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.plugin.v1beta1.LabelService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLabelServiceHandler) GetLabels(context.Context, *connect.Request[v1beta1.GetLabelsRequest]) (*connect.Response[v1beta1.GetLabelsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.GetLabels is not implemented"))
}
...
func (UnimplementedLabelServiceHandler) ListLabels(context.Context, *connect.Request[v1beta1.ListLabelsRequest]) (*connect.Response[v1beta1.ListLabelsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.ListLabels is not implemented"))
}
...
func (UnimplementedLabelServiceHandler) ListLabelHistory(context.Context, *connect.Request[v1beta1.ListLabelHistoryRequest]) (*connect.Response[v1beta1.ListLabelHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.ListLabelHistory is not implemented"))
}
...
func (UnimplementedLabelServiceHandler) CreateOrUpdateLabels(context.Context, *connect.Request[v1beta1.CreateOrUpdateLabelsRequest]) (*connect.Response[v1beta1.CreateOrUpdateLabelsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.CreateOrUpdateLabels is not implemented"))
}
...
func (UnimplementedLabelServiceHandler) ArchiveLabels(context.Context, *connect.Request[v1beta1.ArchiveLabelsRequest]) (*connect.Response[v1beta1.ArchiveLabelsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.ArchiveLabels is not implemented"))
}
...
func (UnimplementedLabelServiceHandler) UnarchiveLabels(context.Context, *connect.Request[v1beta1.UnarchiveLabelsRequest]) (*connect.Response[v1beta1.UnarchiveLabelsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.LabelService.UnarchiveLabels is not implemented"))
}
