...
const file_buf_registry_module_v1beta1_label_service_proto_rawDesc = "" +
	"\n" +
	"/buf/registry/module/v1beta1/label_service.proto\x12\x1bbuf.registry.module.v1beta1\x1a(buf/registry/module/v1beta1/commit.proto\x1a(buf/registry/module/v1beta1/digest.proto\x1a'buf/registry/module/v1beta1/label.proto\x1a*buf/registry/module/v1beta1/resource.proto\x1a\x1bbuf/validate/validate.proto\"e\n" +
	"\x10GetLabelsRequest\x12Q\n" +
	"\n" +
	"label_refs\x18\x01 \x03(\v2%.buf.registry.module.v1beta1.LabelRefB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\tlabelRefs\"Y\n" +
	"\x11GetLabelsResponse\x12D\n" +
	"\x06labels\x18\x01 \x03(\v2\".buf.registry.module.v1beta1.LabelB\b\xbaH\x05\x92\x01\x02\b\x01R\x06labels\"\xbe\x06\n" +
	...
	"\fresource_ref\x18\x03 \x01(\v2(.buf.registry.module.v1beta1.ResourceRefB\x06\xbaH\x03\xc8\x01\x01R\vresourceRef\x12T\n" +
	"\x05order\x18\x04 \x01(\x0e24.buf.registry.module.v1beta1.ListLabelsRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\x12w\n" +
	"\x15commit_check_statuses\x18\x05 \x03(\x0e2..buf.registry.module.v1beta1.CommitCheckStatusB\x13\xbaH\x10\x92\x01\r\"\v\x82\x01\b\x10\x01\x18\x01\x18\x02\x18\x05R\x13commitCheckStatuses\x12'\n" +
	"\n" +
	"name_query\x18\x06 \x01(\tB\b\xbaH\x05r\x03\x18\xfa\x01R\tnameQuery\x12m\n" +
	"\x0earchive_filter\x18\a \x01(\x0e2<.buf.registry.module.v1beta1.ListLabelsRequest.ArchiveFilterB\b\xbaH\x05\x82\x01\x02\x10\x01R\rarchiveFilter\"\x8c\x01\n" +
	"\x05Order\x12\x15\n" +
	...
	"\x06labels\x18\x02 \x03(\v2\".buf.registry.module.v1beta1.LabelR\x06labels\"\x96\x05\n" +
	"\x17ListLabelHistoryRequest\x12%\n" +
	"\tpage_size\x18\x01 \x01(\rB\b\xbaH\x05*\x03\x18\xfa\x01R\bpageSize\x12'\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\x80 R\tpageToken\x12J\n" +
	"\tlabel_ref\x18\x03 \x01(\v2%.buf.registry.module.v1beta1.LabelRefB\x06\xbaH\x03\xc8\x01\x01R\blabelRef\x12Z\n" +
	"\x05order\x18\x04 \x01(\x0e2:.buf.registry.module.v1beta1.ListLabelHistoryRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\x12R\n" +
	"\vdigest_type\x18\x05 \x01(\x0e2'.buf.registry.module.v1beta1.DigestTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\n" +
	"digestType\x12q\n" +
	"\x15commit_check_statuses\x18\x06 \x03(\x0e2..buf.registry.module.v1beta1.CommitCheckStatusB\r\xbaH\n" +
	"\x92\x01\a\"\x05\x82\x01\x02\x10\x01R\x13commitCheckStatuses\x123\n" +
	"\x0fstart_commit_id\x18\a \x01(\tB\v\xbaH\b\xd8\x01\x01r\x03\x88\x02\x01R\rstartCommitId\x12H\n" +
	"!only_commits_with_changed_digests\x18\b \x01(\bR\x1donlyCommitsWithChangedDigests\"=\n" +
	"\x05Order\x12\x15\n" +
	"\x11ORDER_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"ORDER_DESC\x10\x01\x12\r\n" +
	"\tORDER_ASC\x10\x02\"\xd5\x02\n" +
	"\x18ListLabelHistoryResponse\x120\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\x80 R\rnextPageToken\x12S\n" +
	"\x06values\x18\x02 \x03(\v2;.buf.registry.module.v1beta1.ListLabelHistoryResponse.ValueR\x06values\x1a\xb1\x01\n" +
	"\x05Value\x12C\n" +
	"\x06commit\x18\x01 \x01(\v2#.buf.registry.module.v1beta1.CommitB\x06\xbaH\x03\xc8\x01\x01R\x06commit\x12c\n" +
	"\x12commit_check_state\x18\x02 \x01(\v2-.buf.registry.module.v1beta1.CommitCheckStateB\x06\xbaH\x03\xc8\x01\x01R\x10commitCheckState\"\x81\x02\n" +
	"\x1bCreateOrUpdateLabelsRequest\x12c\n" +
	"\x06values\x18\x01 \x03(\v2>.buf.registry.module.v1beta1.CreateOrUpdateLabelsRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a}\n" +
	"\x05Value\x12J\n" +
	"\tlabel_ref\x18\x01 \x01(\v2%.buf.registry.module.v1beta1.LabelRefB\x06\xbaH\x03\xc8\x01\x01R\blabelRef\x12(\n" +
	"\tcommit_id\x18\x02 \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\x88\x02\x01R\bcommitId\"d\n" +
	"\x1cCreateOrUpdateLabelsResponse\x12D\n" +
	"\x06labels\x18\x01 \x03(\v2\".buf.registry.module.v1beta1.LabelB\b\xbaH\x05\x92\x01\x02\b\x01R\x06labels\"i\n" +
	"\x14ArchiveLabelsRequest\x12Q\n" +
	"\n" +
	"label_refs\x18\x01 \x03(\v2%.buf.registry.module.v1beta1.LabelRefB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\tlabelRefs\"\x17\n" +
	"\x15ArchiveLabelsResponse\"k\n" +
	"\x16UnarchiveLabelsRequest\x12Q\n" +
	"\n" +
	"label_refs\x18\x01 \x03(\v2%.buf.registry.module.v1beta1.LabelRefB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\tlabelRefs\"\x19\n" +
	"\x17UnarchiveLabelsResponse2\x8e\x06\n" +
	"\fLabelService\x12o\n" +
	"\tGetLabels\x12-.buf.registry.module.v1beta1.GetLabelsRequest\x1a..buf.registry.module.v1beta1.GetLabelsResponse\"\x03\x90\x02\x01\x12r\n" +
	"\n" +
	"ListLabels\x12..buf.registry.module.v1beta1.ListLabelsRequest\x1a/.buf.registry.module.v1beta1.ListLabelsResponse\"\x03\x90\x02\x01\x12\x84\x01\n" +
	"\x10ListLabelHistory\x124.buf.registry.module.v1beta1.ListLabelHistoryRequest\x1a5.buf.registry.module.v1beta1.ListLabelHistoryResponse\"\x03\x90\x02\x01\x12\x90\x01\n" +
	"\x14CreateOrUpdateLabels\x128.buf.registry.module.v1beta1.CreateOrUpdateLabelsRequest\x1a9.buf.registry.module.v1beta1.CreateOrUpdateLabelsResponse\"\x03\x90\x02\x02\x12{\n" +
	"\rArchiveLabels\x121.buf.registry.module.v1beta1.ArchiveLabelsRequest\x1a2.buf.registry.module.v1beta1.ArchiveLabelsResponse\"\x03\x90\x02\x02\x12\x81\x01\n" +
	"\x0fUnarchiveLabels\x123.buf.registry.module.v1beta1.UnarchiveLabelsRequest\x1a4.buf.registry.module.v1beta1.UnarchiveLabelsResponse\"\x03\x90\x02\x02BaZ_buf.build/gen/go/bufbuild/registry/protocolbuffers/go/buf/registry/module/v1beta1;modulev1beta1b\x06proto3"
