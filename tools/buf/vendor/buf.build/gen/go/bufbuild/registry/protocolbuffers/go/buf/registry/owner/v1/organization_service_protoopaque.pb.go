...
const file_buf_registry_owner_v1_organization_service_proto_rawDesc = "" +
	...
	"\rorganizations\x18\x01 \x03(\v2#.buf.registry.owner.v1.OrganizationB\b\xbaH\x05\x92\x01\x02\b\x01R\rorganizations\"\xe0\x03\n" +
	"\x1aUpdateOrganizationsRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.owner.v1.UpdateOrganizationsRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xe3\x02\n" +
	"\x05Value\x12Y\n" +
	...
	"\x03url\x18\x03 \x01(\tB\x0e\xbaH\v\xd8\x01\x02r\x06\x18\xff\x01\x88\x01\x01H\x01R\x03url\x88\x01\x01\x12w\n" +
