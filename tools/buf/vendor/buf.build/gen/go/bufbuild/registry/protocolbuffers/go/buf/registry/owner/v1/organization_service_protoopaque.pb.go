...
const file_buf_registry_owner_v1_organization_service_proto_rawDesc = "" +
	...
	"\rorganizations\x18\x01 \x03(\v2#.buf.registry.owner.v1.OrganizationB\b\xbaH\x05\x92\x01\x02\b\x01R\rorganizations\"\xe1\x03\n" +
	"\x1aUpdateOrganizationsRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.owner.v1.UpdateOrganizationsRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xe4\x02\n" +
	"\x05Value\x12Y\n" +
	...
	"\vdescription\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\xde\x02H\x00R\vdescription\x88\x01\x01\x12%\n" +
	"\x03url\x18\x03 \x01(\tB\x0e\xbaH\v\xd8\x01\x02r\x06\x18\xff\x01\x88\x01\x01H\x01R\x03url\x88\x01\x01\x12x\n" +
	"\x13verification_status\x18\x04 \x01(\x0e25.buf.registry.owner.v1.OrganizationVerificationStatusB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x02R\x12verificationStatus\x88\x01\x01B\x0e\n" +
	"\f_descriptionB\x06\n" +
	"\x04_urlB\x16\n" +
