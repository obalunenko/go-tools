...
// NewDownloadServiceClient constructs a client for the buf.registry.module.v1beta1.DownloadService
...
// Download calls buf.registry.module.v1beta1.DownloadService.Download.
...
// DownloadServiceHandler is an implementation of the buf.registry.module.v1beta1.DownloadService
// service.
...
func NewDownloadServiceHandler(svc DownloadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.module.v1beta1.DownloadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDownloadServiceHandler) Download(context.Context, *connect.Request[v1beta1.DownloadRequest]) (*connect.Response[v1beta1.DownloadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.module.v1beta1.DownloadService.Download is not implemented"))
}
