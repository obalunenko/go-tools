...
func (*Commit) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1_commit_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_buf_registry_module_v1_commit_proto_rawDescOnce sync.Once
	file_buf_registry_module_v1_commit_proto_rawDescData = file_buf_registry_module_v1_commit_proto_rawDesc
)

func file_buf_registry_module_v1_commit_proto_rawDescGZIP() []byte {
	file_buf_registry_module_v1_commit_proto_rawDescOnce.Do(func() {
		file_buf_registry_module_v1_commit_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_module_v1_commit_proto_rawDescData)
	})
	return file_buf_registry_module_v1_commit_proto_rawDescData
}
