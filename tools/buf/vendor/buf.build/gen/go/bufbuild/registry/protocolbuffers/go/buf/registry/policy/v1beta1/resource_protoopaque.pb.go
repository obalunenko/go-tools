...
func (x *Resource) GetPolicy() *Policy {
	if x != nil {
		if x, ok := x.xxx_hidden_Value.(*resource_Policy); ok {
			return x.Policy
		}
	}
	return nil
...
func (x *Resource) SetPolicy(v *Policy) {
	...
	x.xxx_hidden_Value = &resource_Policy{v}
}
...
func (x *Resource) HasPolicy() bool {
	...
	_, ok := x.xxx_hidden_Value.(*resource_Policy)
	return ok
}
...
func (x *Resource) ClearPolicy() {
	if _, ok := x.xxx_hidden_Value.(*resource_Policy); ok {
		x.xxx_hidden_Value = nil
	}
}
...
func (b0 Resource_builder) Build() *Resource {
	...
	_, _ = b, x
	if b.Policy != nil {
		x.xxx_hidden_Value = &resource_Policy{b.Policy}
	}
	if b.Label != nil {
