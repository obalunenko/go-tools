...
func (PluginVisibility) EnumDescriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_plugin_proto_rawDescGZIP(), []int{0}
}
...
func (PluginState) EnumDescriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_plugin_proto_rawDescGZIP(), []int{1}
}
...
func (PluginType) EnumDescriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_plugin_proto_rawDescGZIP(), []int{2}
}
...
// Deprecated: Use PluginRef_Name.ProtoReflect.Descriptor instead.
func (*PluginRef_Name) Descriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_plugin_proto_rawDescGZIP(), []int{1, 0}
}
...
var (
	file_buf_registry_plugin_v1beta1_plugin_proto_rawDescOnce sync.Once
	file_buf_registry_plugin_v1beta1_plugin_proto_rawDescData = file_buf_registry_plugin_v1beta1_plugin_proto_rawDesc
)

func file_buf_registry_plugin_v1beta1_plugin_proto_rawDescGZIP() []byte {
	file_buf_registry_plugin_v1beta1_plugin_proto_rawDescOnce.Do(func() {
		file_buf_registry_plugin_v1beta1_plugin_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_plugin_v1beta1_plugin_proto_rawDescData)
	})
	return file_buf_registry_plugin_v1beta1_plugin_proto_rawDescData
}
