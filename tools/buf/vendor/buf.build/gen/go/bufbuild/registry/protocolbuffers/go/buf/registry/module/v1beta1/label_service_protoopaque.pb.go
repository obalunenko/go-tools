...
type ListLabelsRequest struct {
	...
	xxx_hidden_Order               ListLabelsRequest_Order         `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.module.v1beta1.ListLabelsRequest_Order"`
	xxx_hidden_CommitCheckStatuses []CommitCheckStatus             `protobuf:"varint,5,rep,packed,name=commit_check_statuses,json=commitCheckStatuses,proto3,enum=buf.registry.module.v1beta1.CommitCheckStatus"`
	xxx_hidden_NameQuery           string                          `protobuf:"bytes,6,opt,name=name_query,json=nameQuery,proto3"`
	xxx_hidden_ArchiveFilter       ListLabelsRequest_ArchiveFilter `protobuf:"varint,7,opt,name=archive_filter,json=archiveFilter,proto3,enum=buf.registry.module.v1beta1.ListLabelsRequest_ArchiveFilter"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
type ListLabelHistoryRequest struct {
	...
	xxx_hidden_Order                         ListLabelHistoryRequest_Order `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.module.v1beta1.ListLabelHistoryRequest_Order"`
	xxx_hidden_DigestType                    DigestType                    `protobuf:"varint,5,opt,name=digest_type,json=digestType,proto3,enum=buf.registry.module.v1beta1.DigestType"`
	xxx_hidden_CommitCheckStatuses           []CommitCheckStatus           `protobuf:"varint,6,rep,packed,name=commit_check_statuses,json=commitCheckStatuses,proto3,enum=buf.registry.module.v1beta1.CommitCheckStatus"`
	xxx_hidden_StartCommitId                 string                        `protobuf:"bytes,7,opt,name=start_commit_id,json=startCommitId,proto3"`
	xxx_hidden_OnlyCommitsWithChangedDigests bool                          `protobuf:"varint,8,opt,name=only_commits_with_changed_digests,json=onlyCommitsWithChangedDigests,proto3"`
	unknownFields                            protoimpl.UnknownFields
	sizeCache                                protoimpl.SizeCache
}
