...
func (ListCommitsRequest_Order) EnumDescriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP(), []int{2, 0}
}
...
func (*GetCommitsRequest) Descriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP(), []int{0}
}
...
func (*GetCommitsResponse) Descriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP(), []int{1}
}
...
func (*ListCommitsRequest) Descriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP(), []int{2}
}
...
func (*ListCommitsResponse) Descriptor() ([]byte, []int) {
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP(), []int{3}
}
...
var (
	file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescOnce sync.Once
	file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescData = file_buf_registry_plugin_v1beta1_commit_service_proto_rawDesc
)

func file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescGZIP() []byte {
	file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescOnce.Do(func() {
		file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescData)
	})
	return file_buf_registry_plugin_v1beta1_commit_service_proto_rawDescData
}
