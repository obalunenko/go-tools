...
func (x *OrganizationRef) SetId(v string) {
	x.Value = &OrganizationRef_Id{v}
}

func (x *OrganizationRef) SetName(v string) {
	x.Value = &OrganizationRef_Name{v}
}
...
func (x *OrganizationRef) HasId() bool {
	...
	_, ok := x.Value.(*OrganizationRef_Id)
	return ok
}
...
func (x *OrganizationRef) HasName() bool {
	...
	_, ok := x.Value.(*OrganizationRef_Name)
	return ok
}
...
func (x *OrganizationRef) ClearId() {
	if _, ok := x.Value.(*OrganizationRef_Id); ok {
		x.Value = nil
	}
}

func (x *OrganizationRef) ClearName() {
	if _, ok := x.Value.(*OrganizationRef_Name); ok {
		x.Value = nil
	}
}
...
func (b0 OrganizationRef_builder) Build() *OrganizationRef {
	...
	_, _ = b, x
	if b.Id != nil {
		x.Value = &OrganizationRef_Id{*b.Id}
	}
	if b.Name != nil {
		x.Value = &OrganizationRef_Name{*b.Name}
	}
	return m0
}
...
var file_buf_registry_owner_v1_organization_proto_rawDesc = string([]byte{
