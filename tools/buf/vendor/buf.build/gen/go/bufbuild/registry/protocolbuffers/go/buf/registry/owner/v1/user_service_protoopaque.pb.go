...
const file_buf_registry_owner_v1_user_service_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x1b.buf.registry.owner.v1.UserB\b\xbaH\x05\x92\x01\x02\b\x01R\x05users\"\x84\x04\n" +
	...
	"\x05order\x18\x04 \x01(\x0e2-.buf.registry.owner.v1.ListUsersRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\x12P\n" +
	"\thas_types\x18\x05 \x03(\x0e2\x1f.buf.registry.owner.v1.UserTypeB\x12\xbaH\x0f\x92\x01\f\x18\x01\"\b\x82\x01\x05\x10\x01\"\x01\x00R\bhasTypes\x12S\n" +
	"\n" +
	"has_states\x18\x06 \x03(\x0e2 .buf.registry.owner.v1.UserStateB\x12\xbaH\x0f\x92\x01\f\x18\x01\"\b\x82\x01\x05\x10\x01\"\x01\x00R\thasStates\"U\n" +
	"\x05Order\x12\x15\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x1b.buf.registry.owner.v1.UserB\b\xbaH\x05\x92\x01\x02\b\x01R\x05users\"\xca\x04\n" +
	"\x12UpdateUsersRequest\x12T\n" +
	"\x06values\x18\x01 \x03(\v2/.buf.registry.owner.v1.UpdateUsersRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xdd\x03\n" +
	"\x05Value\x12A\n" +
	"\buser_ref\x18\x01 \x01(\v2\x1e.buf.registry.owner.v1.UserRefB\x06\xbaH\x03\xc8\x01\x01R\auserRef\x12H\n" +
	"\x05state\x18\x02 \x01(\x0e2 .buf.registry.owner.v1.UserStateB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x00R\x05state\x88\x01\x01\x12/\n" +
