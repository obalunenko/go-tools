...
type ListCommitsRequest struct {
	...
	xxx_hidden_Order       ListCommitsRequest_Order `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.module.v1beta1.ListCommitsRequest_Order"`
...
const file_buf_registry_module_v1beta1_commit_service_proto_rawDesc = "" +
	"\n" +
	"0buf/registry/module/v1beta1/commit_service.proto\x12\x1bbuf.registry.module.v1beta1\x1a(buf/registry/module/v1beta1/commit.proto\x1a(buf/registry/module/v1beta1/digest.proto\x1a*buf/registry/module/v1beta1/resource.proto\x1a\x1bbuf/validate/validate.proto\"\xc3\x01\n" +
	...
	"\acommits\x18\x01 \x03(\v2#.buf.registry.module.v1beta1.CommitB\b\xbaH\x05\x92\x01\x02\b\x01R\acommits\"\xdf\x03\n" +
	...
	"\fresource_ref\x18\x03 \x01(\v2(.buf.registry.module.v1beta1.ResourceRefB\x06\xbaH\x03\xc8\x01\x01R\vresourceRef\x12U\n" +
	"\x05order\x18\x04 \x01(\x0e25.buf.registry.module.v1beta1.ListCommitsRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\x12R\n" +
	...
	"\acommits\x18\x02 \x03(\v2#.buf.registry.module.v1beta1.CommitR\acommits2\xfa\x01\n" +
	"\rCommitService\x12r\n" +
	"\n" +
	"GetCommits\x12..buf.registry.module.v1beta1.GetCommitsRequest\x1a/.buf.registry.module.v1beta1.GetCommitsResponse\"\x03\x90\x02\x01\x12u\n" +
	"\vListCommits\x12/.buf.registry.module.v1beta1.ListCommitsRequest\x1a0.buf.registry.module.v1beta1.ListCommitsResponse\"\x03\x90\x02\x01BaZ_buf.build/gen/go/bufbuild/registry/protocolbuffers/go/buf/registry/module/v1beta1;modulev1beta1b\x06proto3"
...
func file_buf_registry_module_v1beta1_commit_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_buf_registry_module_v1beta1_commit_service_proto_rawDesc), len(file_buf_registry_module_v1beta1_commit_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
