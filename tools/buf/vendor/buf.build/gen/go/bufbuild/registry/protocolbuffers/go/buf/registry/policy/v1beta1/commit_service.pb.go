...
type GetCommitsRequest struct {
	...
	DigestType    DigestType `protobuf:"varint,2,opt,name=digest_type,json=digestType,proto3,enum=buf.registry.policy.v1beta1.DigestType" json:"digest_type,omitempty"`
