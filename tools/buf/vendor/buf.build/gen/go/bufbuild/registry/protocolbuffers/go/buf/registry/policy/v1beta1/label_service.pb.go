...
type ListLabelsRequest struct {
	...
	ArchiveFilter ListLabelsRequest_ArchiveFilter `protobuf:"varint,6,opt,name=archive_filter,json=archiveFilter,proto3,enum=buf.registry.policy.v1beta1.ListLabelsRequest_ArchiveFilter" json:"archive_filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListLabelHistoryRequest struct {
	...
	Order ListLabelHistoryRequest_Order `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.policy.v1beta1.ListLabelHistoryRequest_Order" json:"order,omitempty"`
	...
	DigestType DigestType `protobuf:"varint,6,opt,name=digest_type,json=digestType,proto3,enum=buf.registry.policy.v1beta1.DigestType" json:"digest_type,omitempty"`
