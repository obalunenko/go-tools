...
type ListModulesRequest struct {
	...
	xxx_hidden_Order     ListModulesRequest_Order `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.module.v1.ListModulesRequest_Order"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type CreateModulesRequest_Value struct {
	...
	xxx_hidden_Visibility       ModuleVisibility       `protobuf:"varint,3,opt,name=visibility,proto3,enum=buf.registry.module.v1.ModuleVisibility"`
...
type UpdateModulesRequest_Value struct {
	...
	xxx_hidden_Visibility       ModuleVisibility       `protobuf:"varint,3,opt,name=visibility,proto3,enum=buf.registry.module.v1.ModuleVisibility,oneof"`
	xxx_hidden_State            ModuleState            `protobuf:"varint,4,opt,name=state,proto3,enum=buf.registry.module.v1.ModuleState,oneof"`
...
const file_buf_registry_module_v1_module_service_proto_rawDesc = "" +
	...
	"\amodules\x18\x02 \x03(\v2\x1e.buf.registry.module.v1.ModuleR\amodules\"\xbb\x03\n" +
	"\x14CreateModulesRequest\x12W\n" +
	"\x06values\x18\x01 \x03(\v22.buf.registry.module.v1.CreateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xc9\x02\n" +
	"\x05Value\x12D\n" +
	"\towner_ref\x18\x01 \x01(\v2\x1f.buf.registry.owner.v1.OwnerRefB\x06\xbaH\x03\xc8\x01\x01R\bownerRef\x12\x1d\n" +
	"\x04name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18dR\x04name\x12U\n" +
	"\n" +
	"visibility\x18\x03 \x01(\x0e2(.buf.registry.module.v1.ModuleVisibilityB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\n" +
	"visibility\x12*\n" +
	...
	"\amodules\x18\x01 \x03(\v2\x1e.buf.registry.module.v1.ModuleB\b\xbaH\x05\x92\x01\x02\b\x01R\amodules\"\xcb\x04\n" +
	"\x14UpdateModulesRequest\x12W\n" +
	"\x06values\x18\x01 \x03(\v22.buf.registry.module.v1.UpdateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xd9\x03\n" +
	"\x05Value\x12H\n" +
	"\n" +
	"module_ref\x18\x01 \x01(\v2!.buf.registry.module.v1.ModuleRefB\x06\xbaH\x03\xc8\x01\x01R\tmoduleRef\x12Z\n" +
	"\n" +
	"visibility\x18\x03 \x01(\x0e2(.buf.registry.module.v1.ModuleVisibilityB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x00R\n" +
	"visibility\x88\x01\x01\x12K\n" +
	"\x05state\x18\x04 \x01(\x0e2#.buf.registry.module.v1.ModuleStateB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x01R\x05state\x88\x01\x01\x12/\n" +
