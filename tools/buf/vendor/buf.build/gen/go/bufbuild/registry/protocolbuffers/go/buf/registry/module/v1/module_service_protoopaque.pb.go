...
const (
	...
	ListModulesRequest_ORDER_UPDATE_TIME_DESC ListModulesRequest_Order = 3
	// Order by update_time oldest to newest.
	ListModulesRequest_ORDER_UPDATE_TIME_ASC ListModulesRequest_Order = 4
)
...
const file_buf_registry_module_v1_module_service_proto_rawDesc = "" +
	...
	"\amodules\x18\x01 \x03(\v2\x1e.buf.registry.module.v1.ModuleB\b\xbaH\x05\x92\x01\x02\b\x01R\amodules\"\x85\x03\n" +
	...
	"\x05order\x18\x04 \x01(\x0e20.buf.registry.module.v1.ListModulesRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\"\x8c\x01\n" +
	"\x05Order\x12\x15\n" +
	...
	"\x15ORDER_UPDATE_TIME_ASC\x10\x04\"\x81\x01\n" +
