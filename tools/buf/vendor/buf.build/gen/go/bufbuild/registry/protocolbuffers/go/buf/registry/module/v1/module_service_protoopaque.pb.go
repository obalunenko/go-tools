...
const file_buf_registry_module_v1_module_service_proto_rawDesc = "" +
	...
	"\amodules\x18\x01 \x03(\v2\x1e.buf.registry.module.v1.ModuleB\b\xbaH\x05\x92\x01\x02\b\x01R\amodules\"\xc9\x04\n" +
	"\x14UpdateModulesRequest\x12W\n" +
	"\x06values\x18\x01 \x03(\v22.buf.registry.module.v1.UpdateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xd7\x03\n" +
	"\x05Value\x12H\n" +
	"\n" +
