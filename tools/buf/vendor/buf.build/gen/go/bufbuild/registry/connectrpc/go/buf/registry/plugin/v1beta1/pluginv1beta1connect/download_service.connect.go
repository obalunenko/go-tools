...
const (
	...
	// RPC.
	DownloadServiceDownloadProcedure = "/buf.registry.plugin.v1beta1.DownloadService/Download"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	downloadServiceServiceDescriptor        = v1beta1.File_buf_registry_plugin_v1beta1_download_service_proto.Services().ByName("DownloadService")
...
// NewDownloadServiceClient constructs a client for the buf.registry.plugin.v1beta1.DownloadService
...
// Download calls buf.registry.plugin.v1beta1.DownloadService.Download.
...
// DownloadServiceHandler is an implementation of the buf.registry.plugin.v1beta1.DownloadService
// service.
...
func NewDownloadServiceHandler(svc DownloadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.plugin.v1beta1.DownloadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDownloadServiceHandler) Download(context.Context, *connect.Request[v1beta1.DownloadRequest]) (*connect.Response[v1beta1.DownloadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.DownloadService.Download is not implemented"))
}
