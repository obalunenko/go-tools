...
func (*DownloadRequest) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1_download_service_proto_rawDescGZIP(), []int{0}
}
...
func (*DownloadResponse) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1_download_service_proto_rawDescGZIP(), []int{1}
}
...
func (*DownloadRequest_Value) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1_download_service_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*DownloadResponse_Content) Descriptor() ([]byte, []int) {
	return file_buf_registry_module_v1_download_service_proto_rawDescGZIP(), []int{1, 0}
}
...
var (
	file_buf_registry_module_v1_download_service_proto_rawDescOnce sync.Once
	file_buf_registry_module_v1_download_service_proto_rawDescData = file_buf_registry_module_v1_download_service_proto_rawDesc
)

func file_buf_registry_module_v1_download_service_proto_rawDescGZIP() []byte {
	file_buf_registry_module_v1_download_service_proto_rawDescOnce.Do(func() {
		file_buf_registry_module_v1_download_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_buf_registry_module_v1_download_service_proto_rawDescData)
	})
	return file_buf_registry_module_v1_download_service_proto_rawDescData
}
