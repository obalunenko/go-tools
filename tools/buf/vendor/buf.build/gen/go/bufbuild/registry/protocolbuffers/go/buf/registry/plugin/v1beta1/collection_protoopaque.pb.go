...
type CollectionRef struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Value isCollectionRef_Value  `protobuf_oneof:"value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CollectionRef) GetId() string {
	if x != nil {
		if x, ok := x.xxx_hidden_Value.(*collectionRef_Id); ok {
			return x.Id
		}
	}
	return ""
...
func (x *CollectionRef) GetName() string {
	if x != nil {
		if x, ok := x.xxx_hidden_Value.(*collectionRef_Name); ok {
			return x.Name
		}
	}
	return ""
...
func (x *CollectionRef) SetId(v string) {
	x.xxx_hidden_Value = &collectionRef_Id{v}
}

func (x *CollectionRef) SetName(v string) {
	x.xxx_hidden_Value = &collectionRef_Name{v}
}
...
func (x *CollectionRef) HasId() bool {
	...
	_, ok := x.xxx_hidden_Value.(*collectionRef_Id)
	return ok
}
...
func (x *CollectionRef) HasName() bool {
	...
	_, ok := x.xxx_hidden_Value.(*collectionRef_Name)
	return ok
}
...
func (x *CollectionRef) ClearId() {
	if _, ok := x.xxx_hidden_Value.(*collectionRef_Id); ok {
		x.xxx_hidden_Value = nil
	}
}

func (x *CollectionRef) ClearName() {
	if _, ok := x.xxx_hidden_Value.(*collectionRef_Name); ok {
		x.xxx_hidden_Value = nil
	}
}
...
func (b0 CollectionRef_builder) Build() *CollectionRef {
	...
	_, _ = b, x
	if b.Id != nil {
		x.xxx_hidden_Value = &collectionRef_Id{*b.Id}
	}
	if b.Name != nil {
		x.xxx_hidden_Value = &collectionRef_Name{*b.Name}
	}
	return m0
}
...
var file_buf_registry_plugin_v1beta1_collection_proto_rawDesc = string([]byte{
