...
var (
	uploadServiceServiceDescriptor      = v1beta1.File_buf_registry_plugin_v1beta1_upload_service_proto.Services().ByName("UploadService")
...
// Upload calls buf.registry.plugin.v1beta1.UploadService.Upload.
...
func NewUploadServiceHandler(svc UploadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.plugin.v1beta1.UploadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUploadServiceHandler) Upload(context.Context, *connect.Request[v1beta1.UploadRequest]) (*connect.Response[v1beta1.UploadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.plugin.v1beta1.UploadService.Upload is not implemented"))
}
