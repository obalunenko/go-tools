...
func (ListCommitsRequest_Order) Descriptor() protoreflect.EnumDescriptor {
	return file_buf_registry_policy_v1beta1_commit_service_proto_enumTypes[0].Descriptor()
}

func (ListCommitsRequest_Order) Type() protoreflect.EnumType {
	return &file_buf_registry_policy_v1beta1_commit_service_proto_enumTypes[0]
}
...
type GetCommitsRequest struct {
	...
	xxx_hidden_DigestType   DigestType             `protobuf:"varint,2,opt,name=digest_type,json=digestType,proto3,enum=buf.registry.policy.v1beta1.DigestType"`
...
func (x *GetCommitsRequest) Reset() {
	*x = GetCommitsRequest{}
	mi := &file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes[0]
...
func (x *GetCommitsResponse) Reset() {
	*x = GetCommitsResponse{}
	mi := &file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ListCommitsRequest struct {
	...
	xxx_hidden_Order       ListCommitsRequest_Order `protobuf:"varint,4,opt,name=order,proto3,enum=buf.registry.policy.v1beta1.ListCommitsRequest_Order"`
...
func (x *ListCommitsRequest) Reset() {
	*x = ListCommitsRequest{}
	mi := &file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ListCommitsResponse) Reset() {
	*x = ListCommitsResponse{}
	mi := &file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_buf_registry_policy_v1beta1_commit_service_proto_rawDesc = "" +
	"\n" +
	"0buf/registry/policy/v1beta1/commit_service.proto\x12\x1bbuf.registry.policy.v1beta1\x1a(buf/registry/policy/v1beta1/commit.proto\x1a(buf/registry/policy/v1beta1/digest.proto\x1a*buf/registry/policy/v1beta1/resource.proto\x1a3buf/registry/priv/extension/v1beta1/extension.proto\x1a\x1bbuf/validate/validate.proto\"\xcb\x01\n" +
	"\x11GetCommitsRequest\x12Z\n" +
	"\rresource_refs\x18\x01 \x03(\v2(.buf.registry.policy.v1beta1.ResourceRefB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\fresourceRefs\x12R\n" +
	"\vdigest_type\x18\x02 \x01(\x0e2'.buf.registry.policy.v1beta1.DigestTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\n" +
	"digestType:\x06\xea\xc5+\x02\b\x01\"e\n" +
	"\x12GetCommitsResponse\x12G\n" +
	"\acommits\x18\x01 \x03(\v2#.buf.registry.policy.v1beta1.CommitB\b\xbaH\x05\x92\x01\x02\b\x01R\acommits:\x06\xea\xc5+\x02\x10\x01\"\xe7\x03\n" +
	...
	"\fresource_ref\x18\x03 \x01(\v2(.buf.registry.policy.v1beta1.ResourceRefB\x06\xbaH\x03\xc8\x01\x01R\vresourceRef\x12U\n" +
	"\x05order\x18\x04 \x01(\x0e25.buf.registry.policy.v1beta1.ListCommitsRequest.OrderB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05order\x12R\n" +
	...
	"\x15ORDER_CREATE_TIME_ASC\x10\x02:\x06\xea\xc5+\x02\b\x01\"\x8e\x01\n" +
	"\x13ListCommitsResponse\x120\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x18\x80 R\rnextPageToken\x12=\n" +
	"\acommits\x18\x02 \x03(\v2#.buf.registry.policy.v1beta1.CommitR\acommits:\x06\xea\xc5+\x02\x10\x012\xfa\x01\n" +
	"\rCommitService\x12r\n" +
	"\n" +
	"GetCommits\x12..buf.registry.policy.v1beta1.GetCommitsRequest\x1a/.buf.registry.policy.v1beta1.GetCommitsResponse\"\x03\x90\x02\x01\x12u\n" +
	"\vListCommits\x12/.buf.registry.policy.v1beta1.ListCommitsRequest\x1a0.buf.registry.policy.v1beta1.ListCommitsResponse\"\x03\x90\x02\x01BaZ_buf.build/gen/go/bufbuild/registry/protocolbuffers/go/buf/registry/policy/v1beta1;policyv1beta1b\x06proto3"

var file_buf_registry_policy_v1beta1_commit_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_buf_registry_policy_v1beta1_commit_service_proto_goTypes = []any{
	(ListCommitsRequest_Order)(0), // 0: buf.registry.policy.v1beta1.ListCommitsRequest.Order
	(*GetCommitsRequest)(nil),     // 1: buf.registry.policy.v1beta1.GetCommitsRequest
	(*GetCommitsResponse)(nil),    // 2: buf.registry.policy.v1beta1.GetCommitsResponse
	(*ListCommitsRequest)(nil),    // 3: buf.registry.policy.v1beta1.ListCommitsRequest
	(*ListCommitsResponse)(nil),   // 4: buf.registry.policy.v1beta1.ListCommitsResponse
	(*ResourceRef)(nil),           // 5: buf.registry.policy.v1beta1.ResourceRef
	(DigestType)(0),               // 6: buf.registry.policy.v1beta1.DigestType
	(*Commit)(nil),                // 7: buf.registry.policy.v1beta1.Commit
}
var file_buf_registry_policy_v1beta1_commit_service_proto_depIdxs = []int32{
	5, // 0: buf.registry.policy.v1beta1.GetCommitsRequest.resource_refs:type_name -> buf.registry.policy.v1beta1.ResourceRef
	6, // 1: buf.registry.policy.v1beta1.GetCommitsRequest.digest_type:type_name -> buf.registry.policy.v1beta1.DigestType
	7, // 2: buf.registry.policy.v1beta1.GetCommitsResponse.commits:type_name -> buf.registry.policy.v1beta1.Commit
	5, // 3: buf.registry.policy.v1beta1.ListCommitsRequest.resource_ref:type_name -> buf.registry.policy.v1beta1.ResourceRef
	0, // 4: buf.registry.policy.v1beta1.ListCommitsRequest.order:type_name -> buf.registry.policy.v1beta1.ListCommitsRequest.Order
	6, // 5: buf.registry.policy.v1beta1.ListCommitsRequest.digest_type:type_name -> buf.registry.policy.v1beta1.DigestType
	7, // 6: buf.registry.policy.v1beta1.ListCommitsResponse.commits:type_name -> buf.registry.policy.v1beta1.Commit
	1, // 7: buf.registry.policy.v1beta1.CommitService.GetCommits:input_type -> buf.registry.policy.v1beta1.GetCommitsRequest
	3, // 8: buf.registry.policy.v1beta1.CommitService.ListCommits:input_type -> buf.registry.policy.v1beta1.ListCommitsRequest
	2, // 9: buf.registry.policy.v1beta1.CommitService.GetCommits:output_type -> buf.registry.policy.v1beta1.GetCommitsResponse
	4, // 10: buf.registry.policy.v1beta1.CommitService.ListCommits:output_type -> buf.registry.policy.v1beta1.ListCommitsResponse
...
func init() { file_buf_registry_policy_v1beta1_commit_service_proto_init() }
func file_buf_registry_policy_v1beta1_commit_service_proto_init() {
	if File_buf_registry_policy_v1beta1_commit_service_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_buf_registry_policy_v1beta1_commit_service_proto_rawDesc), len(file_buf_registry_policy_v1beta1_commit_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_buf_registry_policy_v1beta1_commit_service_proto_goTypes,
		DependencyIndexes: file_buf_registry_policy_v1beta1_commit_service_proto_depIdxs,
		EnumInfos:         file_buf_registry_policy_v1beta1_commit_service_proto_enumTypes,
		MessageInfos:      file_buf_registry_policy_v1beta1_commit_service_proto_msgTypes,
	}.Build()
	File_buf_registry_policy_v1beta1_commit_service_proto = out.File
	file_buf_registry_policy_v1beta1_commit_service_proto_goTypes = nil
	file_buf_registry_policy_v1beta1_commit_service_proto_depIdxs = nil
}
