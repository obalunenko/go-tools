...
// NewUploadServiceClient constructs a client for the buf.registry.policy.v1beta1.UploadService
...
func NewUploadServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UploadServiceClient {
	...
	uploadServiceMethods := v1beta1.File_buf_registry_policy_v1beta1_upload_service_proto.Services().ByName("UploadService").Methods()
...
// Upload calls buf.registry.policy.v1beta1.UploadService.Upload.
...
// UploadServiceHandler is an implementation of the buf.registry.policy.v1beta1.UploadService
// service.
...
func NewUploadServiceHandler(svc UploadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.policy.v1beta1.UploadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUploadServiceHandler) Upload(context.Context, *connect.Request[v1beta1.UploadRequest]) (*connect.Response[v1beta1.UploadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.policy.v1beta1.UploadService.Upload is not implemented"))
}
