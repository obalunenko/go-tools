...
// NewResourceServiceClient constructs a client for the buf.registry.module.v1.ResourceService
...
func NewResourceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ResourceServiceClient {
	...
	resourceServiceMethods := v1.File_buf_registry_module_v1_resource_service_proto.Services().ByName("ResourceService").Methods()
...
// GetResources calls buf.registry.module.v1.ResourceService.GetResources.
func (c *resourceServiceClient) GetResources(ctx context.Context, req *connect.Request[v1.GetResourcesRequest]) (*connect.Response[v1.GetResourcesResponse], error) {
	return c.getResources.CallUnary(ctx, req)
}

// ResourceServiceHandler is an implementation of the buf.registry.module.v1.ResourceService
// service.
...
func NewResourceServiceHandler(svc ResourceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/buf.registry.module.v1.ResourceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResourceServiceHandler) GetResources(context.Context, *connect.Request[v1.GetResourcesRequest]) (*connect.Response[v1.GetResourcesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("buf.registry.module.v1.ResourceService.GetResources is not implemented"))
}
