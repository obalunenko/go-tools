...
const file_buf_registry_module_v1beta1_label_proto_rawDesc = "" +
	"\n" +
	"'buf/registry/module/v1beta1/label.proto\x12\x1bbuf.registry.module.v1beta1\x1a3buf/registry/priv/extension/v1beta1/extension.proto\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x05\n" +
	"\x05Label\x12\x1b\n" +
	...
	"\x12updated_by_user_id\x18\t \x01(\tB\v\xbaH\b\xd8\x01\x01r\x03\x88\x02\x01R\x0fupdatedByUserId\x12\xec\x01\n" +
	"\x12commit_check_state\x18\n" +
	" \x01(\v2-.buf.registry.module.v1beta1.CommitCheckStateB\x8e\x01\xbaH\x8a\x01\xba\x01\x83\x01\n" +
	"\x1flabel_commit_check_state_status\x12Fcommit_check_state must have a status of DISABLED, PASSED, or APPROVED\x1a\x18this.status in [1, 2, 5]\xc8\x01\x01R\x10commitCheckState:\x06\xea\xc5+\x02\x10\x01\"\xac\x01\n" +
	"\x10CommitCheckState\x12S\n" +
	"\x06status\x18\x01 \x01(\x0e2..buf.registry.module.v1beta1.CommitCheckStatusB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x06status\x12C\n" +
	"\vupdate_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"updateTime\"\xf0\x01\n" +
	"\bLabelRef\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x88\x02\x01H\x00R\x02id\x12@\n" +
	"\x04name\x18\x02 \x01(\v2*.buf.registry.module.v1beta1.LabelRef.NameH\x00R\x04name\x1an\n" +
	"\x04Name\x12 \n" +
	...
	"\x1cCOMMIT_CHECK_STATUS_APPROVED\x10\x05BaZ_buf.build/gen/go/bufbuild/registry/protocolbuffers/go/buf/registry/module/v1beta1;modulev1beta1b\x06proto3"
