...
func (x case_LabelRef_Value) String() string {
	md := file_buf_registry_module_v1beta1_label_proto_msgTypes[2].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (x case_ScopedLabelRef_Value) String() string {
	md := file_buf_registry_module_v1beta1_label_proto_msgTypes[3].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
var file_buf_registry_module_v1beta1_label_proto_rawDesc = string([]byte{
...
func file_buf_registry_module_v1beta1_label_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_buf_registry_module_v1beta1_label_proto_rawDesc), len(file_buf_registry_module_v1beta1_label_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
