...
const file_buf_registry_module_v1beta1_module_service_proto_rawDesc = "" +
	...
	"\amodules\x18\x01 \x03(\v2#.buf.registry.module.v1beta1.ModuleB\b\xbaH\x05\x92\x01\x02\b\x01R\amodules\"\xdd\x04\n" +
	"\x14UpdateModulesRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.module.v1beta1.UpdateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xe6\x03\n" +
	"\x05Value\x12M\n" +
	"\n" +
