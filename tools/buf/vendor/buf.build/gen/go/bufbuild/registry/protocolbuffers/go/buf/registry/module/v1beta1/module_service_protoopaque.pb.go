...
const file_buf_registry_module_v1beta1_module_service_proto_rawDesc = "" +
	...
	"\amodules\x18\x02 \x03(\v2#.buf.registry.module.v1beta1.ModuleR\amodules\"\xc5\x03\n" +
	"\x14CreateModulesRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.module.v1beta1.CreateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xce\x02\n" +
	"\x05Value\x12D\n" +
	...
	"\n" +
	"visibility\x18\x03 \x01(\x0e2-.buf.registry.module.v1beta1.ModuleVisibilityB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\n" +
	"visibility\x12*\n" +
	...
	"\amodules\x18\x01 \x03(\v2#.buf.registry.module.v1beta1.ModuleB\b\xbaH\x05\x92\x01\x02\b\x01R\amodules\"\xdf\x04\n" +
	"\x14UpdateModulesRequest\x12\\\n" +
	"\x06values\x18\x01 \x03(\v27.buf.registry.module.v1beta1.UpdateModulesRequest.ValueB\v\xbaH\b\x92\x01\x05\b\x01\x10\xfa\x01R\x06values\x1a\xe8\x03\n" +
	"\x05Value\x12M\n" +
	"\n" +
	"module_ref\x18\x01 \x01(\v2&.buf.registry.module.v1beta1.ModuleRefB\x06\xbaH\x03\xc8\x01\x01R\tmoduleRef\x12_\n" +
	"\n" +
	"visibility\x18\x03 \x01(\x0e2-.buf.registry.module.v1beta1.ModuleVisibilityB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x00R\n" +
	"visibility\x88\x01\x01\x12P\n" +
	"\x05state\x18\x04 \x01(\x0e2(.buf.registry.module.v1beta1.ModuleStateB\v\xbaH\b\x82\x01\x05\x10\x01\"\x01\x00H\x01R\x05state\x88\x01\x01\x12/\n" +
	"\vdescription\x18\x05 \x01(\tB\b\xbaH\x05r\x03\x18\xde\x02H\x02R\vdescription\x88\x01\x01\x12%\n" +
	"\x03url\x18\x06 \x01(\tB\x0e\xbaH\v\xd8\x01\x02r\x06\x18\xff\x01\x88\x01\x01H\x03R\x03url\x88\x01\x01\x12=\n" +
