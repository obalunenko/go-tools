...
require (
	...
	cloud.google.com/go/bigquery v1.78.0 // indirect
	...
	github.com/databricks/databricks-sdk-go v0.156.0 // indirect
	github.com/databricks/databricks-sql-go v1.13.1 // indirect
